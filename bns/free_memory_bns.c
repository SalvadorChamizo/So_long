...
/*   Updated: 2024/03/05 14:21:19 by schamizo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	delete_texture(t_game **game)
{
	...
	(*game)->img.ch = NULL;
	mlx_delete_texture((*game)->img.ch2);
	(*game)->img.ch2 = NULL;
	...
	(*game)->img.floor = NULL;
	mlx_delete_texture((*game)->img.enemy);
	(*game)->img.enemy = NULL;
	mlx_delete_texture((*game)->img.sit);
	(*game)->img.sit = NULL;
}
...
void	delete_image(t_game **game)
{
	...
	mlx_delete_image((*game)->mlx, (*game)->img.ch_img2);
	(*game)->img.ch_img2 = NULL;
	...
	mlx_delete_image((*game)->mlx, (*game)->img.enemy2);
	(*game)->img.enemy2 = NULL;
	mlx_delete_image((*game)->mlx, (*game)->img.sit2);
	(*game)->img.sit2 = NULL;
}
